...
export class signin extends Component {
    ...
    onSubmit = (e)=>{
        ...
        const judgingForm ={
            ...
            hostingOrg:this.state.hostingOrg,
            event:this.state.event,
            headcount:this.state.headcount,
            eventLogistics:this.state.eventLogistics,
            questionsAddressed:this.state.questionsAddressed,
            judgingIssues:this.state.judgingIssues,
            eventGraphic:this.state.eventGraphic,
            hostControl:this.state.hostControl,
            creativity:this.state.creativity,
            participantEngagement:this.state.participantEngagement,
            promptness:this.state.promptness,
            audienceEngagement:this.state.audienceEngagement,
            finalThoughts:this.state.finalThoughts,
        }
        //debugging
        console.log(judgingForm);
        //**actually sending data to express then mongo
        axios.post('http://localhost:5000/judging/add',judgingForm)
